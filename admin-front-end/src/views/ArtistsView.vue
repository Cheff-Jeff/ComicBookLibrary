...
<template>
  ...
  <div class="page-wrapper">
    <div class="container">
      <div class="row">
        <div class="col-md-3 spacer" v-for="artist in artists" :key="artist.id">
          <div class="item-wrap">
            <p>
              {{artist.name}}
            </p>
            <div class="row justify-content-between">
              <div class="col-md-6">
                <RouterLink :to="{name: 'updateArtist', params: { id: artist.id }}" class="btn btn-custom">
                  Edit
                </RouterLink>
              </div>
              <div class="col-md-6">
    ...
    <div class="delete-modal" :class="modalToggle" @click="closeModal">
      <div @click.stop class="modal-wrap">
        ...
        <div class="custom-modal-body">
          <p>
            Are you sure you want to delete artist: {{txt}}
          </p>
        </div>
