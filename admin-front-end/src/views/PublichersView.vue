...
<template>
  ...
  <div class="page-wrapper">
    <div class="container">
      <div class="row">
        <div class="col-md-3 spacer" v-for="publicher in publichers" :key="publicher.id">
          <div class="item-wrap">
            <p>
              {{publicher.name}}
            </p>
            <div class="row justify-content-between">
              <div class="col-md-6">
                <RouterLink :to="{name: 'updatePublichers', params: { id: publicher.id }}" class="btn btn-custom">
                  Edit
                </RouterLink>
              </div>
              <div class="col-md-6">
    ...
    <div class="delete-modal" :class="modalToggle" @click="closeModal">
      <div @click.stop class="modal-wrap">
        ...
        <div class="custom-modal-body">
          <p>
            Are you sure you want to delete publicher: {{txt}}
          </p>
        </div>
...
@import "../assets/styles/pages/Publichers.scss";
</style>