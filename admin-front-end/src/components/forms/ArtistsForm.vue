  ...
  <div class="page-wrap">
    <section class="form">
      <div class="title-wrap">
        <h1 v-if="method == 'post'">Add artist</h1>
        <h1 v-else>Update artist</h1>
      </div>
    ...
    async submit() {
      ...
      if(this.nameError == ''){
        ...
        switch (this.method) {
          case 'post':
            try {
              const result = await postRequest(this.name, 'Artists');
          ...
          case 'put':
            try {
              ...
              const result = await putRequest(data, 'Artists')
...
@import "../../assets/styles/forms/artistForm.scss";
</style>